...
export default {
  ...
  methods: {
    fetchProducts() {
      this.loading = true;
      axios
          .get(`https://cs4team1.cs2410-web01pvm.aston.ac.uk/api/DashShoe/admin/get_products?page=${this.currentPage}&per_page=${this.perPage}`)
          .then((response) => {
    ...
    uploadImage(event) {
      ...
      axios.post("https://cs4team1.cs2410-web01pvm.aston.ac.uk/api/DashShoe/admin/upload_image", formData, {
        headers: {
    ...
    saveProductEdit() {
      ...
      if (this.isAddingProduct) {
        ...
        axios.post("https://cs4team1.cs2410-web01pvm.aston.ac.uk/api/DashShoe/admin/add_product", newProduct)
            .then((response) => {
        ...
        const url = `https://cs4team1.cs2410-web01pvm.aston.ac.uk/api/DashShoe/admin/update_product/${this.editProductData.P_ID}`;
    ...
    deleteProduct(productId) {
      if (confirm("Are you sure you want to delete this product?")) {
        axios
            .delete(`https://cs4team1.cs2410-web01pvm.aston.ac.uk/api/DashShoe/admin/delete_product/${productId}`)
            .then((response) => {
