...
const sendReply = async (review) => {
  ...
  try {
    ...
    await axios.patch(`https://cs4team1.cs2410-web01pvm.aston.ac.uk/api/DashShoe/admin/site-reviews/reply/${review.id}`, {
...
const toggleMarkRead = async (review) => {
  ...
  try {
    await axios.put(
        `https://cs4team1.cs2410-web01pvm.aston.ac.uk/api/DashShoe/admin/site-reviews/${review.id}/mark-as-read`,
        { is_read: newState },
        {
          headers: {
            Authorization: `${localStorage.getItem("token_type")} ${localStorage.getItem("jwt")}`
...
const toggleMarkReplied = async (review) => {
  ...
  try {
    await axios.put(
        `https://cs4team1.cs2410-web01pvm.aston.ac.uk/api/DashShoe/admin/site-reviews/${review.id}/mark-as-replied`,
        { is_replied: newState },
        {
          headers: {
            Authorization: `${localStorage.getItem("token_type")} ${localStorage.getItem("jwt")}`
...
const fetchReviews = async () => {
  ...
  try {
    const response = await axios.get(
        "https://cs4team1.cs2410-web01pvm.aston.ac.uk/api/DashShoe/admin/site_review",
        {
          headers: {
            Authorization: `${localStorage.getItem("token_type")} ${localStorage.getItem("jwt")}`
          }
