<template>
  <div id="app">
    ...
    <div class="header">Children's Collection</div>
...
<script>
import ChildrenCollection from "@/scripts/ChildrenCollection.js";

export default ChildrenCollection;

</script>
<style src="@/styles/ChildrenCollectionStyle.css"></style>
