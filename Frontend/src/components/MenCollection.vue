<template>
  <div id="app">
    <header>
      <div class="logo">
        <img src="/src/image/logo three.png" alt="DASH Shoe Logo"/>
      </div>
      <nav>
        <ul>
          ...
          <li>
            <a href="/ShoppingCart"
               class="shopping-cart">
              SHOPPING CART <span v-if="cartCount > 0">({{ cartCount }})</span>
            </a>
          </li>
        </ul>
      </nav>
    ...
    <div class="banner container">
      ...
      <div>
        <img src="/src/image/mens banner.png" alt="Illustration"/>
      </div>
    </div>
...
<script>
import MenCollectionScript from "@/scripts/MenCollectionScript.js";

export default MenCollectionScript;

</script>
<style src="@/styles/MenCollectionStyle.css"></style>